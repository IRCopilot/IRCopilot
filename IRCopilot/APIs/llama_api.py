...
class LlamaAPI(LLMAPI):
    def __init__(self, config_class):
        ...
        api_key = os.getenv("GROQ_API_KEY", None)  # 从环境变量中获取OpenAI的API密钥
        # api_key = ''
        self.client = Groq(
            api_key=api_key,
    ...
    # ) -> str:
        ...
        # except Groq._exceptions.AnthropicError as e:
...
if __name__ == "__main__":
    ...
    llama_api = LlamaAPI(local_config_class)

    # 示例：发送一条简单的 "user" 消息
    conversation_history = [
        {"role": "user", "content": "你好，Llama，你能为我做什么？"}
    ]
